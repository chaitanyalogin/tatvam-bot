...
// ============== smalltalk (skip jokes/memes; we use external files) ==============
...
// ============== “profile” answers (playful who-intro) ==============
const CUES = {
...
function similarity(a,b){ // quick & light
  a=norm(a); b=norm(b);
...
async function webSummary(q){
  return await ddgIA(q) || await wikiSummary(q) || null;
}

// ============== router ==============
const RUDE = ["shut up","stop it","be quiet","chup","band kar","chup kar"];
const CASUAL = ["hi","hello","hey","namaste","hola","yo","wassup","what's up","whats up","good morning","gm","good evening","ge","thanks","shukriya","lol","hahaha","who are you"];
const CAREER = ["project","projects","experience","skills","tech stack","eol","finance","q1","april","may","deployment","iframe","gateway","resume","summary","profile","linkedin","email","company","current company","which company","who is chaitanya","what is chaitanya","education","degree","qualification","introduce chaitanya","present company"];
